...
.center[**Critical Time for Weed Control** is a key component in the **Integrated Weed Management**]
...
- [Zimdahl 1980](https://www.cabi.org/isc/abstract/19802329938) revised conducted studies but no practical use of the concept was reported
...
## Assumptions and Limitations of the CPWC Concept
...
## Determination of Critical Time for Weed Control 
...
## Critical Time for Weed Control in Canola
...
## Critical Time for Weed Control in Soybean
...
- The **critical time for weed control** is best described with a sigmoid regression curve

--

- The **critical time for weed control** vary with location, time and management practices

--

- The **critical time for weed control** has the potential to influence decision making on the timing of postemergence weed management

--

- The **critical time for weed control** is an import part of the integrated weed management

--

- Zero weed tolerance (herbicide resistant weeds) has brought the need of clean fields, reducing use of the **critical time for weed control** concept 
